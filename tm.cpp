...
const size_t   IADDR_SIZE = 1024 /* increase for large programs */
const size_t   DADDR_SIZE = 1024 /* increase for large programs */
const size_t   NO_REGS = 8
const size_t   PC_REG = 7
const size_t
const size_t   LINESIZE = 121
const size_t   WORDSIZE = 20
